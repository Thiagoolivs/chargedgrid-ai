...
CONTENT_HINTS = {
    ...
    "vincular": "vincul",
    "vinculado": "vincul",
    "faturamento": "1006",  # registros de faturamento começam com 1006x
    "medidor": "1017",      # registros de medidor começam com 1017x
    "consumo": "10061",
    "duracao": "10063",
    "acumulada": "10065",
    "leitura": "1017",
    "mid": "MID",
    "temperatura": "+50",   # temperatura máxima
    "ip": "IP5",            # proteção IP54
...
def retrieve_context(question, k=10, fetch_k=50):
    ...
    docs = vectorstore.max_marginal_relevance_search(
        question,
        k=fetch_k,
        fetch_k=max(fetch_k, 60),  # Aumentado de 40 para 60 para buscar mais candidatos
    )
    ...
    for index, doc in enumerate(relevant_docs, start=1):
        ...
        if source not in seen_sources:
            ...
            sources.append({"source": source, "rank": index})
